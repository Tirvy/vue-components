      ...
      items: [
        {
          name: 'Дроп-Даун',
          alias: 'drop-down',
          tech: 'components/drop-list. DropDownSlot - отдельная компонента, её здесь не рассматриваем',
          description: `Стандартный дропдаун, реализующий как набивание чекбоксов, так и выбор элемента из списка.
           Реализован достаточно умный поиск.
           Может быть с деревом или нет. 
           Нормально обрабатывает ОГРОМНЫЕ списки (список на 10 000 элементов представлен ниже)`,
        },
        {
          name: 'Тогглер',
          alias: 'toggler',
